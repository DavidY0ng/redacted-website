...
function LeftFrame() {
  return (
    <div className="relative ml-1 flex h-screen  md:h-[200vh] flex-col items-center justify-center gap-10 md:ml-3 ">
      <img
        src={leftElement1}
        loading="eager"
...
function RightFrame() {
  return (
    <div className="relative mr-1 flex h-screen  md:h-[200vh] flex-col items-center justify-center gap-10 md:mr-3">
      <img
        src={rightElement2}
        loading="eager"
...
export default function WholeFrame() {
  return (
    <>
      <div className="absolute z-10 h-screen w-full md:h-[200vh]">
        <LeftFrame />
      </div>
      <div className="absolute z-10 h-screen w-full md:h-[200vh]">
        <RightFrame />
